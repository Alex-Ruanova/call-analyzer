...
export function useTweaks(defaults: TweakDefaults): [TweakDefaults, (key: keyof TweakDefaults, val: TweakDefaults[keyof TweakDefaults]) => void] {
  const [values, setValues] = useState<TweakDefaults>(defaults);
  const setTweak = useCallback(
    (key: keyof TweakDefaults, val: TweakDefaults[keyof TweakDefaults]) => {
...
// ---- useRouterTweaks (integrate with App) ----
// Exported so App.tsx can use it independently of TweaksPanel
export { useMemo };
